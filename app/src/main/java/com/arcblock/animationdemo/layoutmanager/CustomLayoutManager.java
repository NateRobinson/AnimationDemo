package com.arcblock.animationdemo.layoutmanager;
...
public class CustomLayoutManager extends RecyclerView.LayoutManager {
    ...
    public int scrollVerticallyBy(int dy, RecyclerView.Recycler recycler, RecyclerView.State state) {
        Log.e("CustomLayoutManager", "dy===>" + dy);
        //先detach掉所有的子View
        detachAndScrapAttachedViews(recycler);
        //实际要滑动的距离
        int travel = dy;
        ...
        if (verticalScrollOffset + dy < 0) {
            ...
            Log.e("CustomLayoutManager", "111=>travel===>" + travel);
        } else if (verticalScrollOffset + dy > totalHeight - getVerticalSpace()) {
            //如果滑动到最底部  travel 为 0
            travel = totalHeight - getVerticalSpace() - verticalScrollOffset;
            Log.e("CustomLayoutManager", "222=>travel===>" + travel);
        }
        //将竖直方向的偏移量+travel
